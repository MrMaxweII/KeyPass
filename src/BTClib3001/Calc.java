...
/********************************************************************************************************************
*	Version 1.7    	diese Version ist nun ohne Bouncycastle-LIB erstellt  		Autor: Mr. Maxwell	vom 30.01.2023 	*
...
/** Berechnet den PublicKey aus einem Private-Key.
	@param key Übergeben wird der Private-Key als Hex-String (32Byte)
...
public static String getPublicKey(String key, boolean compressed)
{
    byte[] b = getPublicKey(Convert.hexStringToByteArray(key),compressed);
...
// Veriante mit Bouncycastle-Lib. Diese Methode ist jetzt in der "Secp256k1_BC" Class
// Da die LIB-Bouncycaslte aus dieser Klasse herausgehalten werden soll.
//public static byte[] getPublicKey(byte[] privateKey, boolean compressed)
//{
